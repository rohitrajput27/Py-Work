...
def prepareRequest(accountId, transactionId):
    body = ('<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:seas="http://www.charter.com/solo/synch/seasonal">'
   +'<soapenv:Header>'
    +'<seas:charterHeaderInputInfo>'
       +'<clientCallingService>SEASONALRESEND</clientCallingService>'
        +'<auditUser>' + reason + '</auditUser>'
         +'<transactionId>' + transactionId + '</transactionId>'
 +'</seas:charterHeaderInputInfo>'
  +'</soapenv:Header>'
   +'<soapenv:Body>'
    +'<seas:sendSeasonalSuspendMessageRequest>'
